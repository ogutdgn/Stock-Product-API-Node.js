...
module.exports = {
    ...
    read: async (req, res) => {
        ...
        */        
        ...
        //! Prevent unauthorized user from managing another user (own data only):
        ...
        if (req.user.isAdmin) {
            ...
            data = await User.findOne({ _id: req.user.id });
        } else {
            throw new Error("No permission to reach this user.");
        }
